# AOC23 D17p2: Clumsy Crucible thanks to hyper-neutrino https://github.com/hyper-neutrino/advent-of-code/blob/main/2023/day17p2.py
...
def main() -> None:
    ...
    while pq:
        ...
        if r == len(city_map) - 1 and c == len(city_map[0]) - 1 and n >= 4:
            print(hl)
            break
